...
CT = {
    ...
    0xE7: {
        ...
        0x04: ("JOB_PASSES", PASSES, PASSES, XRELCOORD35, YRELCOORD35),
        0x05: ("ARRAY_DIRECTION", DIRECTION),
        0x06: ("FEED_REPEAT", UINT35, UINT35),
        0x07: ("JOB_BOTTOM_RIGHT", XABSCOORD, YABSCOORD),
        0x08: ("ARRAY_PASSES", PASSES, PASSES, XRELCOORD35, YRELCOORD35),
    ...
    0xF2: {
        ...
        0x05: ("ELEMENT_PASSES", PASSES, PASSES, XRELCOORD35, YRELCOORD35),
